...
object NetFlowV5Packet {
  ...
  /**
    ...
    */
  def apply(sender: InetSocketAddress, buf: ByteBuf)(implicit system: ActorSystem): Try[NetFlowV5Packet] =
    Try[NetFlowV5Packet] {
  ...
  def apply(sender: InetSocketAddress,
            ...
            samplingInterval: Int)(implicit system: ActorSystem): Option[NetFlowV5] =
    Try[NetFlowV5] {
...
case class NetFlowV5Packet(id: UUID,
                           sender: InetSocketAddress,
                           length: Int,
                           uptime: Long,
                           timestamp: LocalDateTime,
                           flows: List[NetFlowV5],
                           flowSequence: Long,
                           engineType: Int,
                           engineId: Int,
